...
```bash
# 使用特定版本
docker pull ghcr.io/zhao-zg/ai-codereview:v1.4.0
docker pull ghcr.io/zhao-zg/ai-codereview:v1.4.0-worker
```
...
services:
  ...
  worker:
    image: ghcr.io/zhao-zg/ai-codereview:latest-worker
    # ... 其他配置
```
...
services:
  app:
    image: ghcr.io/zhao-zg/ai-codereview:v1.4.0
```
