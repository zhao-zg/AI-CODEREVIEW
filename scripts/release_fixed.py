...
此版本的Docker镜像将自动构建并发布到多个仓库：

**Docker Hub:**
- `zzg1189/ai-codereview-gitlab:{tag.replace('v', '')}`
- `zzg1189/ai-codereview-gitlab:{tag.replace('v', '')}-worker`
...
def main():
    ...
    print(f"🌐 检查构建状态: https://github.com/zzg1189/ai-codereview-gitlab/actions")
    print(f"📦 Docker镜像将发布到: zzg1189/ai-codereview-gitlab")
